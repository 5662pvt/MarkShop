...
namespace MarkShop
{
    ...
    partial void InserttbComMent(tbComMent instance);
    partial void UpdatetbComMent(tbComMent instance);
    partial void DeletetbComMent(tbComMent instance);
    #endregion
		...
		public System.Data.Linq.Table<tbComMent> tbComMents
		{
			get
			{
				return this.GetTable<tbComMent>();
			}
		}
	}
	...
	public partial class KhachHang : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<tbComMent> _tbComMents;
    ...
    partial void OnSDTChanged();
		...
		public KhachHang()
		{
			...
			this._tbComMents = new EntitySet<tbComMent>(new Action<tbComMent>(this.attach_tbComMents), new Action<tbComMent>(this.detach_tbComMents));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KhachHang_tbComMent", Storage="_tbComMents", ThisKey="MaKH", OtherKey="MaKH")]
		public EntitySet<tbComMent> tbComMents
		{
			get
			{
				return this._tbComMents;
			}
			set
			{
				this._tbComMents.Assign(value);
			}
		}
		...
		private void attach_tbComMents(tbComMent entity)
		{
			this.SendPropertyChanging();
			entity.KhachHang = this;
		}
		
		private void detach_tbComMents(tbComMent entity)
		{
			this.SendPropertyChanging();
			entity.KhachHang = null;
		}
    ...
    partial void OnSoLuongTonChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_tbComMent", Storage="_tbComMents", ThisKey="MaSP", OtherKey="MaSP")]
		public EntitySet<tbComMent> tbComMents
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tbComMent")]
	public partial class tbComMent : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _ComentMsg;
		
		private System.Nullable<System.DateTime> _ComentDate;
    ...
    partial void OnComentMsgChanging(string value);
    partial void OnComentMsgChanged();
    partial void OnComentDateChanging(System.Nullable<System.DateTime> value);
    partial void OnComentDateChanged();
    ...
    partial void OnRateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ComentMsg", DbType="NVarChar(MAX)")]
		public string ComentMsg
		{
			get
			{
				return this._ComentMsg;
			}
			set
			{
				if ((this._ComentMsg != value))
				{
					this.OnComentMsgChanging(value);
					this.SendPropertyChanging();
					this._ComentMsg = value;
					this.SendPropertyChanged("ComentMsg");
					this.OnComentMsgChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ComentDate", DbType="DateTime")]
		public System.Nullable<System.DateTime> ComentDate
		{
			get
			{
				return this._ComentDate;
			}
			set
			{
				if ((this._ComentDate != value))
				{
					this.OnComentDateChanging(value);
					this.SendPropertyChanging();
					this._ComentDate = value;
					this.SendPropertyChanged("ComentDate");
					this.OnComentDateChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="KhachHang_tbComMent", Storage="_KhachHang", ThisKey="MaKH", OtherKey="MaKH", IsForeignKey=true)]
		public KhachHang KhachHang
		{
			get
			{
			...
			set
			{
							...
							|| (this._KhachHang.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._KhachHang.Entity = null;
						previousValue.tbComMents.Remove(this);
					}
					this._KhachHang.Entity = value;
					if ((value != null))
					{
						value.tbComMents.Add(this);
						this._MaKH = value.MaKH;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SanPham_tbComMent", Storage="_SanPham", ThisKey="MaSP", OtherKey="MaSP", IsForeignKey=true)]
		public SanPham SanPham
		{
			get
			{
